...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Mail, color: "hover:bg-primary", href: "mailto:littlefybpl@gmail.com", label: "Email" },
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-3 pt-4">
            ...
            <div className="flex items-center gap-3 text-sm text-muted-foreground group">
              ...
              <a href="mailto:littlefybpl@gmail.com" className="font-body font-medium hover:text-primary transition-colors">littlefybpl@gmail.com</a>
            </div>
            <div className="flex items-center gap-3 text-sm text-muted-foreground group">
        ...
        <div className="pt-10 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-muted-foreground font-body text-sm font-medium">
            © {currentYear} <span className="font-black text-foreground">Pricekam</span>. Crafted by <span className="text-primary font-bold">Vintvate</span>
          </p>
